(() => {
  ...
  const i18n = {
    en: {
      ...
      app1Title: "Hi 5 Daily",
      app1Text: "A lightweight productivity companion that keeps tasks, notes, and routines in sync.",
      app2Title: "Trade Compass",
      app2Text: "Track shipments, documents, and milestones with a simple, mobile-first workflow.",
    ...
    zh: {
      ...
      app1Title: "Hi 5 Daily（示例）",
      app1Text: "轻量的效率工具，让任务、笔记与日常习惯保持同步。",
      app2Title: "Trade Compass（示例）",
      app2Text: "以移动优先的方式管理运输、单证与关键节点。",
